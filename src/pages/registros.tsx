  ...
  return (
    <BaseLayout>
      {registros.map((registro, idx) => {
        ...
        return (
          <div key={idx} className="border-opacity-94 flex  w-full flex-col items-start gap-4 rounded-lg border bg-white bg-opacity-75 p-4 text-2xl text-white shadow-md backdrop-blur-sm backdrop-filter ">
